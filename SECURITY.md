...
Currently, we only support the latest version of QRVEF.
...
We will acknowledge your report within 48 hours and provide a timeline for a fix. Please include:
* A description of the vulnerability.
* The potential impact.
* Steps to reproduce or a Proof of Concept (PoC).

Thank you for helping keep the privacy of our users secure.